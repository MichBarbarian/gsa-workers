...
| [`wallet_funding_transfers`](./workers/wallet_funding_transfers/README.md) | every 6h | `is_valid_funding_transfers` (non-Dormant first) | First ~500 incoming → `wallets.wallet_funding_transfers` |
