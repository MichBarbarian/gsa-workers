...
| [`wallet_activity_flows`](./workers/wallet_activity_flows/README.md) | UTC 06:00→24:00 (cuts 1/15 06:00 + drain 6,10,14,18,22; closed 00–06) | `is_valid_activity_flows` + not `Dormant_*` | 15d transfers → staging `wallets.wallet_activity_transfers` |
| [`wallet_funding_transfers`](./workers/wallet_funding_transfers/README.md) | UTC 06:00→24:00 (drain 6,12,18; closed 00–06) | `is_valid_funding_transfers` (non-Dormant first) | First ~500 incoming → `wallets.wallet_funding_transfers` |
