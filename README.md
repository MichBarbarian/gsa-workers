...
| [`wallet_activity_flows`](./workers/wallet_activity_flows/README.md) | 1/15 00:00 + every 4h (00–24 UTC) | `is_valid_activity_flows` + not `Dormant_*` | 15d transfers → staging `wallets.wallet_activity_transfers` |
